...
java -Xmx1g $JMS_URL_SETTING -classpath $DISTDIR/embots.jar:$JARDIR/JCup.jar:$JARDIR/JFlex.jar:$JARDIR/JOSC.jar:$JARDIR/SceneMaker3.jar:$JARDIR/jama.jar:$JARDIR/jsr173_1.0_api.jar:$JARDIR/xml-text-editor-0.0.2.jar:$JARDIR/semaine.jar:$JARDIR/semaine-mary.jar:$JARDIR/semaine-dialogue.jar:$JARDIR/JBML.jar:$JARDIR/log4j-1.2.15.jar:$JARDIR/commons-logging-1.1.1.jar:$JARDIR/activemq-all-5.1.0.jar:$JARDIR/JaCoP-3.1.jar:$JARDIR/jdom.jar:$JARDIR/jgraph.jar:$JARDIR/affect.jar -Dmary.base="$MARYDIR" eu.semaine.system.ComponentRunner $CONFIG
