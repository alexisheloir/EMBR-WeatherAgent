...
public class GazeZone {
    ...
    public static ZoneCentre getZone(double xPos,double yPos)
    {
    ...
    public static ZoneCentre getZone(int xZoneID,int yZoneID)
    {
   ...
   public static int getXZoneID(double xPos)
   {
        if(xPos<0 || xPos>1 )
        {
     ...
     public static int getYZoneID(double yPos)
   {
          if(yPos<0 ||yPos >1)
        {
    ...
    public static int getZoneIndex(Triple triple)
    {
        return getZoneIndex(getXZoneID(triple.x),getYZoneID(triple.y));
    }
